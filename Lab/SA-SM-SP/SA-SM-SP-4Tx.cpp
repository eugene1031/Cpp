...
void receive()//void frame_length()
{
	...
	for (int i = 0; i < frame_w; i++)
	{
		...
		//new define
		st2.col(0) << I_me.col(sp840[sp][0] - 1);
		st2.col(1) << I_me.col(sp840[sp][1] - 1);
		st2.col(2) << I_me.col(sp840[sp][2] - 1);
		st2.col(3) << I_me.col(sp840[sp][3] - 1);
		st2.col(4) << I_me.col(sp840[sp][4] - 1);
		st2.col(5) << I_me.col(sp840[sp][5] - 1);
		st2.col(6) << I_me.col(sp840[sp][6] - 1);
		st2.col(7) << I_me.col(sp840[sp][7] - 1);
